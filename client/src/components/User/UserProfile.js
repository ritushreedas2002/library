...
const UserProfile = ({ user, onEditProfileClick }) => {
  ...
  return (
    <div className="w-[70%] h-[80%] ml-80 mx-auto bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center">
                  <div className="rounded-full h-56 w-56 ml-6 mt-10 overflow-hidden mr-40 object-cover">
                    <img
                      src={
                        profileImage
                          ? profileImage
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="mt-4 p-4 bg-red-200">
                      <h2 className="text-lg font-semibold text-blue-500">
                        Username:
                      </h2>
                      <h2 className="text-gray-800 pl-3 text-lg font-semibold">
                        {name}
                      </h2>
                    </div>
                    <div className="mt-4">
