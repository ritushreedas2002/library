...
const Chatbot = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      const response = await fetch(
        `https://library-pi-nine.vercel.app/api/chat-messages/${userId}`
      );
      if (!response.ok) {
  ...
  const handleSendClick = async ({input}) => {
    ...
    try {
      ...
      const response = await fetch("https://library-pi-nine.vercel.app/api/chat-messages", {
        method: "POST",
        headers: {
  ...
  const textQuery = async (userText) => {
    try {
      ...
      const response = await fetch("https://library-pi-nine.vercel.app/text-query", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      await fetch("https://library-pi-nine.vercel.app/api/chat-messages", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
